...
def parse_argument():
    ...
    parser.add_argument("--val_check_interval", default= 200, type=int)
    parser.add_argument("--log_every_n_steps", default= 200, type=int)
    ...
    parser.add_argument("--prefix", default="translate to SNOMED :", type=str)
    parser.add_argument("--source_col", default="new_val", type=str)
    parser.add_argument("--target_col", default="SNOMED_PROCESSED", type=str)
